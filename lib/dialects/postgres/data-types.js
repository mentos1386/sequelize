...
module.exports = BaseTypes => {
  ...
  function LTREE() {
    ...
    BaseTypes.LTREE.apply(this, arguments);
  }
  inherits(LTREE, BaseTypes.LTREE);

  BaseTypes.LTREE.types.postgres = {
    oids: [],
    array_oids: []
  };

  LTREE.parse = LTREE.prototype.parse = function parse(value) {
    return value
  };
